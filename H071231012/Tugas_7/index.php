...
if ($role == 'admin' && isset($_POST['tambah'])) {
    ...
    // Validasi input: cek apakah semua field sudah diisi
...
<body class="bg-cover" style="background-image : url('img/2.jpg');">
    <div class="container mx-auto mt-5 px-4">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-white">Role: <?= ucfirst($role) ?></span>
        </div>
        ...
        <?php if ($role == 'admin') { ?>
            <!-- Form Tambah/Edit Data Mahasiswa (hanya bisa dilihat oleh admin) -->
                        ...
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <?php if ($role == 'admin') { ?>
                                <td class="px-4 py-2 text-center">
                                    <a href="?edit=<?= $row['id']; ?>" class="text-blue-500 hover:text-blue-700 mr-2">Edit</a>
