...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div>
            ...
            @if (session('success'))
                <div class="bg-green-100 border border-green-400 text-red-600 px-4 py-3 rounded relative mb-4"
                    role="alert">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-5xl font-bold text-red-600">Manajemen Log Inventaris</h2>
            <a href="{{ route('inventory-logs.create') }}"
                style="padding: 10px; background-color:red; border-radius: 10px; color: #fff"><i
            ...
            <div class="px-4 py-5 sm:px-6">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-center text-lx font-large text-red-600  uppercase tracking-wider">
                                Tanggal
                            </th>
                            <th class="px-6 py-3 text-center text-lx font-large text-red-600  uppercase tracking-wider">
                                Produk
