        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
                <a href="{{ url('/') }}" class="text-white font-bold text-2xl flex items-center">
                    <img src="image/logo.png" alt="Logo" class="h-12 mr-2">
                    EN-Shop
                </a>                
            </div>
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    <a href="{{ route('products.index') }}"
                       class="{{ request()->is('products*') ? 'bg-blue-800 text-white' : 'text-gray-100' }} hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                       Produk
                    </a>
                    <a href="{{ route('categories.index') }}"
                       class="{{ request()->is('categories*') ? 'bg-blue-800 text-white' : 'text-gray-100' }} hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                       Kategori
                    </a>
                    <a href="{{ route('inventory-logs.index') }}"
                       class="{{ request()->is('inventory-logs*') ? 'bg-blue-800 text-white' : 'text-gray-100' }} hover:bg-blue-800 hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                       Log Inventaris
                    </a>
                </div>
            </div>
