...
@section('content')
    <div class="max-w-7xl mx-auto px-4 lx:px-6 lg:px-8 mt-8">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-5xl font-bold text-red-600 ">Manajemen Kategori</h2>
            <a href="{{ route('categories.create') }}" style="padding: 10px; background-color:red; border-radius: 10px; color: #fff"><i class="fas fa-plus"></i> Kategori</a>
        </div>
